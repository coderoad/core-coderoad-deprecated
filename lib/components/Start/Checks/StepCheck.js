...
var StepCheck = function (_a) {
    ...
    return (React.createElement(Stepper_1.Step, { completed: completed, active: !completed },
        React.createElement(Stepper_1.StepLabel, { icon: completed ? React.createElement(FontIcon_1.default, null, "\u2713") : React.createElement(warning_1.default, { color: colors_1.red500 }) }, label),
...
//# sourceMappingURL=StepCheck.js.map